...
const parameters_1 = require("./src/parameters");
let usaParameters = new parameters_1.Parameters();
let brazilianParameters = new parameters_1.Parameters();
//It sets the parameters to generate a new USA date format
usaParameters.usa = true;
let usa = new date_operations_manipulator2_1.DateManipulator(usaParameters);
//It sets the parameters to generate a new Brazilian date format
let br = new date_operations_manipulator2_1.DateManipulator(brazilianParameters);
...
usa = new date_operations_manipulator2_1.DateManipulator(usaParameters);
...
br = new date_operations_manipulator2_1.DateManipulator(brazilianParameters);
...
usa = new date_operations_manipulator2_1.DateManipulator(brazilianParameters);
console.log(`Current date: ${currentBrDate}`);
console.log(`5 more months: ${usa.addMonthsToDate()}`);
