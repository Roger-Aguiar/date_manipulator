...
let usa = new date_operations_manipulator2_1.DateManipulator(true);
let br = new date_operations_manipulator2_1.DateManipulator(false, true);
...
usa = new date_operations_manipulator2_1.DateManipulator(true, false, currentUSAdate, 3);
...
br = new date_operations_manipulator2_1.DateManipulator(false, true, currentBrDate, 3);
console.log(`3 more years: ${br.addYearsToDate()}`);
//It adds 5 days - USA
console.log("\nIt adds 5 days - USA");
usa = new date_operations_manipulator2_1.DateManipulator(true, false, currentUSAdate, 0, 0, 5);
console.log(`Current date: ${currentUSAdate}`);
console.log(`5 more days: ${usa.addDaysToDate()}`);
//It adds 5 days - Brazil
console.log("\nIt adds 5 days - Brazil");
br = new date_operations_manipulator2_1.DateManipulator(false, true, currentBrDate, 0, 0, 5);
console.log(`Current date: ${currentBrDate}`);
...
usa = new date_operations_manipulator2_1.DateManipulator(true, false, "02-25-2022", 0, 0, 15);
...
br = new date_operations_manipulator2_1.DateManipulator(false, true, "25-02-2022", 0, 0, 15);
console.log("Current date: 25-02-2022");
console.log(`15 more days: ${br.addDaysToDate()}`);
//It adds 5 months when date is 05/09/2022 - USA
console.log("\nIt adds 5 months when date is 05/09/2022 - USA");
usa = new date_operations_manipulator2_1.DateManipulator(true, false, currentUSAdate, 0, 5, 0);
console.log(`Current date: ${currentUSAdate}`);
console.log(`5 more months: ${usa.addMonthsToDate()}`);
//It adds 5 months when date is 09/05/2022 - Brazil
console.log("\nIt adds 5 months when date is 09/05/2022 - Brazil");
usa = new date_operations_manipulator2_1.DateManipulator(false, true, currentBrDate, 0, 5, 0);
console.log(`Current date: ${currentBrDate}`);
console.log(`5 more months: ${usa.addMonthsToDate()}`);
...
usa = new date_operations_manipulator2_1.DateManipulator(true, false, "12-21-2022", 0, 6);
...
usa = new date_operations_manipulator2_1.DateManipulator(false, true, "21-12-2022", 0, 6);
...
usa = new date_operations_manipulator2_1.DateManipulator(true, false, currentUSAdate, 0, 12, 0);
console.log(`Current date: ${currentUSAdate}`);
...
br = new date_operations_manipulator2_1.DateManipulator(false, true, currentBrDate, 0, 12, 0);
console.log(`Current date: ${currentBrDate}`);
...
usa = new date_operations_manipulator2_1.DateManipulator(true, false, "05-31-2022", 0, 1, 0);
...
br = new date_operations_manipulator2_1.DateManipulator(false, true, "31-05-2022", 0, 1, 0);
...
usa = new date_operations_manipulator2_1.DateManipulator(true, false, "11-15-2022", 0, 5, 0);
...
usa = new date_operations_manipulator2_1.DateManipulator(false, true, "15,11,2022", 0, 5, 0);
